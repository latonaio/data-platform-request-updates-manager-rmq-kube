...
type ParticipationDocSDC struct {
...
type ParticipationDoc struct {
	...
	HeaderDoc		ParticipationHeaderDoc	`json:"HeaderDoc"`
}

type ParticipationHeaderDoc struct {
	Participation            int     `json:"Participation"`
...
func ParticipationDocInputRead(
	controller *beego.Controller,
) ParticipationDocSDC {
	var requestBody ParticipationDocSDC
